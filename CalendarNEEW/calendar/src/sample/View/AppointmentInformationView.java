...
/*
* This class describes the informationview associated with an appointment
*/

public class AppointmentInformationView {

    private boolean isDisabled = true;
    private VBox layout;

    //The constructor for AppointmentInformationView
    public AppointmentInformationView(String title, Controller controller, Appointment appointment) {
