...
public class LeftMenu extends VBox{
    ...
    public LeftMenu(Controller controller) {
        ...
        calendar.setStyle("-fx-font: 22 arial; -fx-base: #9a6262;");
        calendar.setOnAction(e-> controller.changeToWeekView(controller.getWeekView()));
        ...
        inventory.setStyle("-fx-font: 22 arial; -fx-base: #9a6262;");
        ...
        cashOut.setStyle("-fx-font: 22 arial; -fx-base: #9a6262;");
        ...
        profiles.setStyle("-fx-font: 22 arial; -fx-base: #9a6262;");
