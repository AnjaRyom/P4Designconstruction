...
public class Inventory {
    ...
    private Map<Article, Integer> lowStock; // this represents the case where the stock is too low
    private List<LowStockListener> lowStockListenerList;

    // This is the start if there is already an existing stock.
    public Inventory(Map<Article, Integer> numberInStock, Map<Article, Integer> lowStock) {
