...
public class Service extends Product {
    ...
    private Map<String, Integer> requiredProducts; //products (eg. shampoo) and the amount of them that should be used.
    ...
    public Map<String, Integer> getRequiredProducts() { return requiredProducts; }
