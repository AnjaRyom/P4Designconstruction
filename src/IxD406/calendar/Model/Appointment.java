...
public class Appointment implements Comparable<Appointment> {
    ...
    public Appointment(int hour, int minute, int durationInMinutes, int phoneNumber, Week.Day day, IxD406.calendar.Model.Employee employee, String customer, int weekNumber, int IDforDatabase, Service service) {
        this.hour = hour;
        this.minute = minute;
    ...
    public IxD406.calendar.Model.Employee getEmployee() { return employee; }
    ...
    public void setEmployee(IxD406.calendar.Model.Employee employee) { this.employee = employee; }
